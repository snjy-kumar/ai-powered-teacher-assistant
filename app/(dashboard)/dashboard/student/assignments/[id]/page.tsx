...
function getAssignment(id: string) {
  ...
  return {
    ...
    description:
      "Write a 1500-word analysis of the themes in 'To Kill a Mockingbird' by Harper Lee.",
        ...
        <div className="md:col-span-2">
          ...
          >
            <TabsList className="justify-start mb-6">
              <TabsTrigger
                value="details"
                className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-black rounded-lg px-6 py-2 transition-all duration-200"
              >
                Details
              </TabsTrigger>
              <TabsTrigger
              ...
              <Card className="p-6 shadow-lg">
                ...
                <ul className="space-y-2 mb-6">
                  {assignment.gradingCriteria.map(
                    (criteria: GradingCriteria, i: number) => (
                      <li
                        key={i}
                  ...
                  <div className="bg-muted/30 p-6 rounded-lg text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      {assignment.submissionDate &&
                        `You submitted this assignment on ${new Date(
                          assignment.submissionDate
                        ).toLocaleDateString()}`}
                    </p>
                  ...
                  <div>
                    ...
                    <div className="bg-muted/30 p-4 rounded-lg mb-6">
                      ...
                      <p className="text-muted-foreground whitespace-pre-line">
                        Excellent work on your literary analysis! Your thesis
                        was clear and you provided strong evidence from the text
                        to support your arguments. Your analysis of the
                        symbolism throughout the novel was particularly
                        insightful. Areas for improvement: - Consider exploring
                        the historical context more deeply - Some paragraphs
                        could benefit from stronger topic sentences Overall, a
                        very strong essay that demonstrates a deep understanding
                        of the text.
                      </p>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 shadow-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              If you have questions about this assignment, contact your
